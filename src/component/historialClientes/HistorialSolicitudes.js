...
function HistorialSolicitudes(props) {
    ...
    const fetchData = async () => {
        ...
        console.log(
            '🚀 ~ file: HistorialSolicitudes.js ~ line 21 ~ fetchData ~ allRequest',
            allRequest
        );
            ...
            $(document).ready(function () {
                let tablaPlanes = $('.table').DataTable({
                    ...
                    columns: [
                        { title: '#' },
                        { title: 'ID Solicitud' },
                        { title: 'ID Tipo Solicitud' },
                        { title: 'ID Estado Solicitud' },
                        { title: 'Fecha Publicacion' },
                        {
                            title: 'Acciones',
                            render: function (data, arr) {
                                return `
                            <a href="#" class="detallesSolicitud" data-toggle="modal" data-target="#detallesSolicitud" data="${data}">

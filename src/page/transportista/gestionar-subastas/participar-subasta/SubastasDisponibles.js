            ...
            <div class='col-sm-4'>
                <div class='card'>
                    <div class='card-body'>
                        ...
                        <p class='card-text'>
                            Nombre cliente: {auction.customerName}
                        </p>
                        <p class='card-text'>
                            Fecha publicación: {auction.fechaPublicacion}
                        </p>
                        <p class='card-text'>Kilos: {auction.kilos}</p>
                        <a
                            href={`/transportista/gestionar-subastas/participar-subastas/detalle-subasta/${auction.auctionId}`}
            ...
            <ul className='list-group mb-5'>
                <li className='list-group-item'>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            history.push('/transportista/gestionar-subastas');
                        }}
                    >
                        Volver atrás
                    </Button>

...
function ParticiparSubasta() {
    ...
    const displayTrucks = trucks.map((truck) => {
        return <option value={truck.idCamion}>{truck.patente}</option>;
    });
        ...
        try {
            ...
            swal({
                ...
                window.location.href =
                    '/transportista/gestionar-subastas/participar-subastas';
            });
        } catch (error) {
            swal({
                title: error,
        ...
        <div className='container'>
            ...
            >
                ...
                <div className='row'>
                    ...
                    <div className='mb-5'>{displayRoutes}</div>
                </div>
            </header>

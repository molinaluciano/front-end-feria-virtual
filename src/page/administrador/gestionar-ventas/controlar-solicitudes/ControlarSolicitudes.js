...
import { getAllRequest } from '../../../../service/Cliente-Externo/request-service';
import EditarEstadoSolicitud from './EditarEstadoSolicitud';

function ControlarSolicitudes(props) {
                    ...
                    columns: [
                        ...
                        { title: 'Fecha Publicacion' },
                        {
                            ...
                            render: function (data, arr) {
                              ...
                              <a href="/administrador/gestionar-ventas/controlar_solicitudes/${data}" data="${data}">
...
export default ControlarSolicitudes;

      ...
      <ul className="list-group mb-5">
        ...
        <form onSubmit={sendForm}>
          ...
          <div class="row mb-2 mt-4">
            ...
            <textarea onChange={handleInputChange} type="text" class="form-control" id="descripcionContrato" name="descripcionContrato" placeholder=""/>
            </div>
          </div>
          <div className="row mt-3">
            <div className="col-6">    
              <Link to="/administrador/gestionar-usuarios/gestionar-productores" className="btn btn-primary w-75">
                Ir hacia atrás
              </Link>
            </div>
            <div className="col-6">

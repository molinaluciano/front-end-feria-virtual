...
function EditarTransportista() {
  ...
  const loadData = () => {
    $(document).on('click', '.editarInputs', function (e) {
      ...
      console.log(
        '🚀 ~ file: EditarTransportista.js ~ line 25 ~ EditarTransportista ~ formData',
        formData,
      )
    })
  }
  ...
  $(document).on('click', '.borrarInput', function (e) {
    ...
    swal({
      ...
      if (resultButton) {
        const resultDeleted = await borrarCliente(idUsuario, 7)
  ...
  return (
    <div className="modal fade" id="editarTransportista">
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h4 className="modal-title">Editar Transportista</h4>
          </div>

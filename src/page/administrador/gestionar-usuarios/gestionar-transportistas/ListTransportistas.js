        ...
        let tablaPlanes = $('.table').DataTable({
          ...
          columns: [
            ...
            { title: 'Correo' },
            {
              ...
              <a href="#" class="editarInputs" data-toggle="modal" data-target="#editarTransportista" data="${data}">
        ...
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-md-12">
              <h1 className="m-0 text-dark">Gestion de Transportistas</h1>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="col-lg-12">
              <div className="card card-primary card-outline">
                <div className="card-header">
                  <h5 className="m-0">
                    <Link
                      to="/administrador/gestionar-usuarios/gestionar-transportistas/nuevo-transportista"
